...
uint8_t active_fan = 0; // used to determine which fan
int fanSpeed = 0; // used for nozzle 0 fan
int fanSpeed1 = 0; // used for nozzle 1 fan
...
Sigma_Exit:
    ...
    case 190: // M190 - Wait for bed heater to reach target.
      ...
      case 106: //M106 Fan On
        // determine which nozzle fan to switch on
        if (code_seen('P')){
...
case 404:  //M404 Enter the nominal filament width (3mm, 1.75mm ) N<3.0> or display nominal filament width
  ...
  {
    tmp_extruder = code_value();
    // below 3 lines taken from stock taz 4 firmware. not sure of purpose
